...
export default function HermesDashboard() {
  ...
  const paperBalance = useMemo(() => {
    const defaultVal = 10284.32;
    const addedVal = mockTradesSimulated * 42.15;
    return defaultVal + addedVal;
  }, [mockTradesSimulated]);

  const pnlPct = useMemo(() => {
    const defaultPct = 2.84;
    const addedPct = (mockTradesSimulated * 0.11);
    return Number((defaultPct + addedPct).toFixed(2));
  }, [mockTradesSimulated]);
        ...
        <div className="lg:col-span-7 flex flex-col gap-3">
          ...
          <section className="p-4 bg-slate-900/10 rounded-sm border border-slate-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs font-mono">
              ...
              {/* Card 1: SOL-PERP */}
              <div className="p-3 bg-slate-900/40 rounded-sm border border-slate-800 flex flex-col justify-between hover:border-cyan-500/20 transition-all select-none gap-2">
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-1.5 py-0.5 rounded-sm text-[9px] font-bold bg-[#100c0e]/40 border border-[#861616]/30 text-rose-400 uppercase tracking-widest flex items-center gap-1">
                      LONG <span className="font-sans">▲</span> 1.32%
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-x-2 gap-y-1.5 mt-3 text-slate-450">
                    <div>
                      ...
                      <strong className="text-slate-200">144.78</strong>
                    </div>
                    <div>
                      <span className="text-slate-500 text-[10px] uppercase block">Current Price</span>
                      <strong className="text-slate-200">146.69</strong>
                    </div>
                    <div>
                      <span className="text-slate-500 text-[10px] uppercase block">Unrealized PnL</span>
                      <strong className="text-emerald-400 font-bold font-mono">+$38.42 <span className="text-[10px] font-normal text-emerald-500/80">(+1.32%)</span></strong>
                    </div>
                    <div>
                      <span className="text-slate-500 text-[10px] uppercase block">Size / Risk</span>
                      <strong className="text-slate-200">$1,250.00 <span className="text-slate-500 text-[10px] font-normal">/ 0.75%</span></strong>
                    </div>
                  </div>
                </div>

                {/* Technical boundaries: stop loss, targets */}
                <div className="bg-[#050607]/60 p-2 rounded-sm border border-slate-800 grid grid-cols-3 gap-1 divide-x divide-slate-800/80 text-[10px] text-center mt-1">
                  <div>
                    ...
                    <span className="text-rose-400 font-bold">138.20</span>
                    <span className="text-[9px] text-slate-600 block">-4.55%</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block uppercase text-[9px]">TP1</span>
                    <span className="text-emerald-400 font-bold">150.80</span>
                    <span className="text-[9px] text-slate-600 block">+4.15%</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block uppercase text-[9px]">TP2</span>
                    <span className="text-cyan-400 font-bold">158.60</span>
                    <span className="text-[9px] text-slate-600 block">+9.54%</span>
                  </div>
                </div>

                {/* Tiny Green Sparkline */}
                <div className="h-6 w-full overflow-hidden flex items-center opacity-80 mt-1 select-none">
                  <svg viewBox="0 0 160 30" className="w-full h-full stroke-emerald-500 stroke-1.5 fill-none">
                    <path d="M0 15 L20 20 L40 10 L60 25 L80 15 L100 8 L120 18 L140 5 L160 2 Q160 15 160 30" strokeLinecap="round" />
                  </svg>
                </div>
                ...
                <div className="flex items-center justify-between text-[10px] text-slate-500 mt-1 pt-1 border-t border-slate-800/60 font-mono">
                  <span>Confidence: <strong className="text-emerald-400 bg-emerald-900/15 px-1 rounded-sm">78</strong></span>
                  <span>Time Open: <strong className="text-slate-300">2h 17m</strong></span>
                </div>

                <p className="text-[10px] text-slate-400 italic font-mono leading-normal bg-[#050607]/40 p-1.5 rounded-sm border border-slate-850">
                  “Holding because stop not hit and TP1 not reached.”
                </p>
              </div>
              ...
              <div className="p-3 bg-slate-900/40 rounded-sm border border-slate-800 flex flex-col justify-between hover:border-cyan-500/20 transition-all select-none gap-2">
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-1.5 py-0.5 rounded-sm text-[9px] font-bold bg-[#100c0e]/40 border border-[#861616]/30 text-rose-400 uppercase tracking-widest flex items-center gap-1">
                      LONG <span className="font-sans">▲</span> 0.87%
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-x-2 gap-y-1.5 mt-3 text-slate-450">
                    <div>
                      <span className="text-slate-500 text-[10px] uppercase block">Entry Price</span>
                      <strong className="text-slate-200">2,965.40</strong>
                    </div>
                    <div>
                      <span className="text-slate-500 text-[10px] uppercase block">Current Price</span>
                      <strong className="text-slate-200">2,991.21</strong>
                    </div>
                    <div>
                      <span className="text-slate-500 text-[10px] uppercase block">Unrealized PnL</span>
                      <strong className="text-emerald-400 font-bold font-mono">+$64.82 <span className="text-[10px] font-normal text-emerald-500/80">(+0.87%)</span></strong>
                    </div>
                    <div>
                      <span className="text-slate-500 text-[10px] uppercase block">Size / Risk</span>
                      <strong className="text-slate-200">$1,480.00 <span className="text-slate-500 text-[10px] font-normal">/ 0.88%</span></strong>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#050607]/60 p-2 rounded-sm border border-slate-800 grid grid-cols-3 gap-1 divide-x divide-slate-800/80 text-[10px] text-center mt-1">
                  <div>
                    <span className="text-slate-500 block uppercase text-[9px]">Stop</span>
                    <span className="text-rose-400 font-bold">2,855.00</span>
                    <span className="text-[9px] text-slate-600 block">-3.72%</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block uppercase text-[9px]">TP1</span>
                    <span className="text-emerald-400 font-bold">3,080.00</span>
                    <span className="text-[9px] text-slate-600 block">+3.86%</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block uppercase text-[9px]">TP2</span>
                    <span className="text-cyan-400 font-bold">3,240.00</span>
                    <span className="text-[9px] text-slate-600 block">+9.25%</span>
                  </div>
                </div>
                ...
                <div className="h-6 w-full overflow-hidden flex items-center opacity-80 mt-1 select-none">
                  <svg viewBox="0 0 160 30" className="w-full h-full stroke-emerald-500 stroke-1.5 fill-none">
                    <path d="M0 12 L20 18 L40 5 L60 14 L80 20 L100 12 L120 10 L140 4 L160 1 Q160 15 160 30" strokeLinecap="round" />
                  </svg>
                </div>

                {/* State parameters */}
                <div className="flex items-center justify-between text-[10px] text-slate-500 mt-1 pt-1 border-t border-slate-800/60 font-mono">
                  <span>Confidence: <strong className="text-emerald-400 bg-emerald-900/15 px-1 rounded-sm">72</strong></span>
                  <span>Time Open: <strong className="text-slate-300">1h 41m</strong></span>
                </div>
